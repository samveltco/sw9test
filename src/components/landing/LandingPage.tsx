                        ...
                        <div className="header_inner">
                            ...
                            <div className="menu_block">
                                <ul className="main_menu">
                                    ...
                                    <li><a href="#" onClick={(e) => { e.preventDefault(); showModal(); }}>Sign in</a></li>
                    ...
                    <div className="page_container">
                        <div className="main_section">
                            ...
                            <div className="main_btn">
                                <a href="#" className="btn_signIn" onClick={(e) => { e.preventDefault(); showModal(); }}>Sign in</a>
                                <a href="#" className="btn_signUp">Sign up</a>
                            </div>
                        </div>
